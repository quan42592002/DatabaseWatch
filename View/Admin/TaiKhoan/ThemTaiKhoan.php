        ...
        <div class="card-body p-2" style="padding-top: 0;">
            ...
            <form method="post" action="http://localhost:3000/Controller/admin/Crud/TaiKhoan/ThemTaiKhoan.php" onsubmit="return validateForm(event)">
                ...
                <div class="form-group p-1" style="padding-top: 0px;">
                    ...
                    <input type="text" class="form-control form-control-lg" name="user_name" id="UserName" required autocomplete="off">
                ...
                <div class="form-group p-1" style="padding-top: 0px;">
                    ...
                    <div style="position: relative;">
                        <input type="password" class="form-control form-control-lg" name="mat_khau" id="Password" required autocomplete="off">
                        <button style="position: absolute; right: 0; top: 50%; transform: translateY(-50%); color:#D0CFCF; font-size:18px; border:none; background-color:#fff;" type="button" id="togglePassword" class="toggle-password" onclick="togglePasswordVisibility()">
                ...
                <div class="form-group p-1" style="padding-top: 0px;">
                    ...
                    <div style="position: relative;">
                        <input type="password" class="form-control form-control-lg" name="xac_nhan_mat_khau" id="Password1" required autocomplete="off">
                        <button style="position: absolute; right: 0; top: 50%; transform: translateY(-50%); color:#D0CFCF; font-size:18px; border:none; background-color:#fff;" type="button" id="togglePassword1" class="toggle-password" onclick="togglePasswordVisibility1()">
                            <i class="mdi mdi-eye"></i>
                        </button>
                    </div>
                </div>
